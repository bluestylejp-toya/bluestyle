<section>
    ...
    <div class="chain-help">
        ...
        <dl>
            <dt>利用料はいくらですか？</dt>
            <dd>現在は利用料無料となっております。</dd>
        </dl>
        <dl>
            <dt>Chainにかかる費用を教えてください。</dt>
            <dd>Chainが成立した時に、送ってもらう送料が発生します。<br>
                出品者の居住地によって送料は事なります。<br>
                アイテムごとにかかる送料は、ログインするとアイテム詳細ページに表記されます。</dd>
        </dl>
        <dl>
        ...
        <dl>
            <dt>「ほしい」が押せません。</dt>
            <dd>クレジットカードを登録しないと「ほしい」が押せません。</dd>
        </dl>
        <dl>
            <dt>欲しいアイテムがないです。</dt>
            <dd>申し訳ありません。<br>
        ...
        <dl>
            ...
            <dd>ご自身が他のアイテムに対して「ほしい」したら、Chainが成立する可能性があります。<br>また、「もらえる」タブに表示されているアイテムを「ほしい」するとChain成立します。</dd>
        </dl>
        <dl>
            <dt>禁止アイテムはなんですか？</dt>
