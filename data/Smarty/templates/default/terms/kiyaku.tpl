<section>
    ...
    <ol class="c-list--order u-mb--4">
        ...
        <li>「出品」とは、ユーザーが、本サービスにて、アイテムの授受に必要なコンテンツを掲載・発信し、他のユーザーが閲覧可能かつユーザーがアイテムを「授受したい」と意思表示できる状態にすることをいいます。</li>
        <li>「出品者」とは、本サービスを通じてアイテムを出品するユーザーをいいます。</li>
        <li>「Chain成立」とは、ユーザーが他のユーザーが出品したアイテムに対して、授受を希望する意思表示（以下「ほしい」という）を行い、ほしいをされたユーザーが、さらに別のユーザーが出品したアイテムに対してほしいを行なった際に、それぞれのアイテムに対してのほしいが連なった状態のことを言います。</li>
