<section>
    ...
    <p class="u-mb--4">弊社は、本サービスに接したユーザー及び第三者の、<a href="./prohibited_activities.php">禁止されている行為</a>に該当すると弊社が合理的な理由に基づき判断する行為（以下「禁止事項」といいます。）を禁止します。</p>
...
<<<<<<< HEAD
    ...
    <p class="u-mb--2">出品者は<a href="./prohibited_items.php">禁止されている出品物</a>（以下「出品禁止物」といいます。）に記載された商品の出品ができないことについて、予め了承します。出品禁止物に該当する商品を出品した場合は、出品者の故意又は過失に関わらず、本規約違反行為とみなします。</p>
