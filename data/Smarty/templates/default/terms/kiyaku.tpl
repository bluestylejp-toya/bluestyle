<section>
    ...
    <ol class="c-list--order u-mb--4">
        <li>本サービスは、オンラインリユースサービスです。ユーザー（次条で定義します。）間のアイテムの授受ができる場・機会を提供するもので、ユーザー間のアイテム授受の保証等に関しては、すべて当事者であるユーザーの自己責任とし、授受の委託を受けるものでもありません。弊社は、本規約中に別段の定めがある場合を除き、アイテム授受の遂行には一切関与しません。</li>
        <li>本サービスの内容は、本利用規約及びガイドに規定する通りとします。</li>
    </ol>
    <h2 class="c-heading--subtitle u-text--left">第 2 条 定義</h2>
    <h3 class="u-mb--1 c-heading--subtitle--sm">1. 定義</h3>
    <ol class="c-list--order u-mb--4">
        ...
        <li>「ユーザー」とは、本サービスを利用する人をいいます。</li>
        ...
        <li>「出品」とは、ユーザーが、本サービスにて、アイテムの授受に必要なコンテンツを掲載・発信し、他のユーザーが閲覧可能かつユーザーがアイテムを「ほしい」と意思表示できる状態にすることをいいます。</li>
        <li>「出品者」とは、本サービスを通じてアイテムを出品するユーザーをいいます。</li>
        <li>「Chain成立」とは、ユーザーが他のユーザーが出品したアイテムに対して、授受を希望する意思表示（以下「ほしい」という）を行い、「ほしい」をされたユーザーが、さらに別のユーザーが出品したアイテムに対して「ほしい」を行なった際に、それぞれのアイテムに対しての「ほしい」が連なった状態のことを言います。</li>
        ...
        <li>「利用料」とは、本サービスの利用に関連して、弊社がユーザーから徴収する料金をいいます。</li>
    </ol>
    <h3  class="u-mb--1">2. 適用</h3>
    <p class="u-mb--4">本条の定義は、別途定義されている場合及び文脈上別異に解すべき場合を除き、本利用規約のほか、プライバシーポリシー及びChainの利用ガイドにおいても、適用されるものとします。</p>
    <h2 class="c-heading--subtitle u-text--left">第 3 条 本規約への同意及び本規約の変更</h2>
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 本規約への同意及び適用</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 未成年者の場合</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 本規約の変更</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 登録</h3>
    <p class="u-mb--2">ユーザー登録は、必ず本人が行ってください。また、ユーザー登録の際は、必ず正確な情報を入力してください。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 複数登録の禁止</h3>
    <p  class="u-mb--2">個人のユーザー及びユーザー登録をしようとする方（以下併せて「ユーザー等」といいます）は、複数のユーザー登録を行うことができないものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 登録拒否</h3>
    <p class="u-mb--2">弊社は、ユーザー登録をしようとする方が以下各号のいずれかに該当する場合、ユーザー登録の申請を承認しないことがあります。</p>
    <ol class="c-list--order u-mb--4">
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. ユーザー等の確約</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">5. 登録内容の変更</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">6. アカウント情報の管理</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">7. アカウント情報の不正利用等</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">8. アカウント情報の漏えい</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. ユーザー登録の取消・利用停止等</h3>
    ...
    <ol class="c-list--order u-mb--2">
        ...
        <li>ユーザーが登録したクレジットカードに関し違法、不適切その他の問題があることが当該金融機関による指摘等により判明した場合</li>
        <li>第 4 条第 3 項各号のいずれかに該当する場合</li>
        <li>ユーザーが自ら又は第三者に対して、暴力的な要求行為、法的な責任を超えた不当な要求行為、脅迫的な言動若しくは暴力を用いる行為、又は風評を流布し、偽計を用い若しくは威力を用いて、信用を毀損若しくは業務を妨害する行為をした場合</li>
        <li>その他弊社がユーザーに相応しくないと判断した場合</li>
    </ol>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. サービスの利用禁止等</h3>
    <p class="u-mb--2">弊社は、本条の措置を受けたユーザーに対し、将来にわたって弊社が提供するサービスの利用及びアクセスを禁止することができるものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 弊社の免責</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 退会の手続</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 弊社の免責</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. プライバシーポリシー</h3>
    <p class="u-mb--2">弊社は、本規約のほか、プライバシーポリシーに従って個人情報等を取り扱います。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. プライバシーポリシーへの同意</h3>
    <p class="u-mb--2">ユーザーは、本サービスの利用又は本サービスの閲覧の前に、本サービス上で、プライバシーポリシーを必ず確認し、その内容に同意した上で、本サービスを利用するものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. ユーザーによる利用</h3>
    ...
    <p class="u-mb--4">弊社は、本サービスに接したユーザー及び第三者の、<a href="./prohibited_activities.php">ガイドの禁止されている行為</a>に該当すると弊社が合理的な理由に基づき判断する行為（以下「禁止事項」といいます。）を禁止します。</p>
    <h2 class="c-heading--subtitle u-text--left">第 9 条 アイテムの出品</h2>
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 出品手続等</h3>
    <p class="u-mb--2">出品者は、弊社所定の手続に従いアイテムの出品を行うものとします。出品者は、本規約の定めに従って本サービスを利用するものとします。 弊社は、ガイド記載の特定の出品方法について基準を設け、審査を行い、出品者が基準に合致しない場合には、当該出品方法の利用を制限することができます。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 出品禁止商品</h3>
    <p class="u-mb--2">出品者は<a href="./prohibited_items.php">ガイドの禁止されている出品物</a>（以下「出品禁止物」といいます。）に記載された商品の出品ができないことについて、予め了承します。出品禁止物に該当する商品を出品した場合は、出品者の故意又は過失に関わらず、本規約違反行為とみなします。</p>

    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 商品説明等</h3>
    <p class="u-mb--2">ユーザーは、アイテムを出品する際に、真に授受する意思のない出品、そのアイテム情報だけでは正しくアイテムを理解できない又は混乱する可能性のある出品、アイテム説明で十分な説明を行わない出品等を行ってはなりません。また、出品者は、出品するアイテムと関係のない画像等を当該出品情報として掲載してはいけません。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. 法令遵守</h3>
    <p class="u-mb--2">ユーザーは、出品にあたっては、古物営業法、特定商取引に関する法律、不当景品類及び不当表示防止法、不正競争防止法、商標法、著作権法その他の法令を遵守しなければなりません。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">5. 出品に関する本規約違反</h3>
    <p class="u-mb--2">出品に関して、弊社が本規約又は加盟店規約に違反する又は不適切であると合理的な理由に基づき判断した場合、弊社は、第 5 条に定める措置のほか、その出品やその出品に対して発生していた授受を弊社の判断で取消すことができるものとします。本項に基づく措置によってユーザーに生じる損害について、弊社の故意又は過失に起因する場合を除き、弊社は責任を負わないものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">6. 弊社の免責</h3>
    <p class="u-mb--4">ユーザーの出品等によって、ユーザー及び第三者に生じる損害につき、弊社の故意又は過失に起因する場合を除き、弊社は責任を負わないものとします。</p>
    <h2 class="c-heading--subtitle u-text--left">第 10 条 アイテムの授受</h2>
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 授受手続</h3>
    <p class="u-mb--2">ユーザーは、弊社の定める手続により授受の意思をもって、授受を行うものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 購入意思等</h3>
    <p class="u-mb--2">ユーザーは、授受する意思のないの意思表示等、及び弊社の判断でいたずら目的と見受けられる授受の意思表示を行うことはできません。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 必要データ</h3>
    <p class="u-mb--2">弊社が定める取引開始可能な時間内に、弊社の管理するサーバーに交換意思のアクションデータなどの弊社所定のデータの到達が確認できなかった場合、授受は無効になるものとし、ユーザーは予めこれを承諾するものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. 弊社の免責</h3>
    <p class="u-mb--4">ユーザーの出品、授受等によって、ユーザー及び第三者に生じる損害につき、弊社の故意又は過失に起因する場合を除き、弊社は責任を負わないものとします。</p>
    <h2 class="c-heading--subtitle u-text--left">第 11 条 支払及び取引の実行</h2>
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 授受契約の成立</h3>
    <p class="u-mb--2">交換者が出品された特定のアイテムのChain成立の確定をした時をもって当該アイテムの授受契約が成立するものとします。ユーザーは、授受契約に基づき発生した権利義務を第三者に譲渡、担保提供その他の処分することはできないものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 支払期限及び送料</h3>
    <p class="u-mb--2">授受契約が成立した場合、交換者は、弊社の定める方法により利用料と送料の合計額を支払うものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 発送</h3>
    <p class="u-mb--2">出品者は、Chain成立が確定した後にアイテムの発送をするものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. アイテム等に関するトラブル</h3>
    <p class="u-mb--2">ユーザーの間でアイテム等に関してトラブルが発生した場合は当該ユーザー間で解決するものとします。但し、弊社の判断により、弊社も協議に入ることができるものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">5. キャンセル及びアイテムの瑕疵</h3>
    <p class="u-mb--2">本サービスの利用にあたり、アイテムのChain成立の確定後のキャンセルはできないものとします。 アイテムに瑕疵がある場合、アイテム説明と実際のアイテムが明らかに異なる場合、梱包の不備により配送時にアイテムが破損したなどの場合は出品者が責任を負うものとし、出品者の責任及び費用により、アイテムの返品、修理、交換等の対応を行うものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">6. 支払手続</h3>
    <ol class="c-list--order u-mb--2">
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">7. 不払・支払遅延等</h3>
    <ol class="c-list--order u-mb--2">
        <li>ユーザーが本規約に従って必要な支払いを行わない場合若しくは遅延した場合又は本サービスに入力したクレジットカードが停止された場合には、弊社は、当該ユーザーに通知することなく、当該ユーザーによる本サービスの利用を停止することができるほか、第 5 条に定める措置をとることができるものとします。</li>
        <li>支払期日までに購入者が支払債務を支払わなかった場合、弊社は、当該ユーザーに対し、年率 14.6％の遅延損害金を請求することができるものとします。</li>
    </ol>
    <h3 class="u-mb--2 c-heading--subtitle--sm">8. 弊社の免責</h3>
    <p class="u-mb--4">ユーザーが本サービスに入力した決済手段の情報が第三者に利用されたこと若しくは入力情報の内容が不正確であったこと又は弊社が本条に基づく措置を行ったこと若しくは行わなかったことによってユーザーに生じた損害に関して、弊社の故意又は過失に起因する場合を除き、弊社は責任を負わないものとします。</p>
    <h2 class="c-heading--subtitle u-text--left">第 16 条 弊社による商品の出品等</h2>
    <ol class="c-list--order u-mb--4">
        <li>弊社は、本サービスにおいて、商品の出品を行う場合があります。なお、その場合も、本サービスがユーザー間のアイテムの交換の場・機会を提供するオンラインリユースサービスであるとの性質には何ら影響を及ぼしません。</li>
        <li>弊社が出品したアイテムとChain成立したユーザーは、アイテムに瑕疵がある場合又は品違いの場合は、弊社所定の方法により弊社に連絡するものとします。この場合には、ユーザーは、アイテムの返送等につき弊社の指示に従うものとし、弊社は、返金、アイテム交換その他の弊社が適切と認める措置をとることができるものとします。</li>
    </ol>
    <h2 class="c-heading--subtitle u-text--left">第 17 条 弊社によるアイテムの配送</h2>
    <ol class="c-list--order u-mb--4">
        <li>弊社が本サービスにおいてアイテムの出品を行う場合、弊社は、自ら又は配送業者を通じて、受領者にアイテムを配送します。受領者は、弊社又は弊社から委託を受けた配送業者が、アイテム配送のため、夜間を含め、電話等にて受領者に日時の確認その他の連絡を行う場合があることを承諾します。</li>
        <li>受領者は、アイテムの配送時にアイテム配送先住所に不在の場合、当該配送時に配布する不在票に従って、配送日から弊社又は配送業者所定の日数以内に、再配送日時を指定するものとします。前記の期間内に再配送日の指定がない場合若しくは再配送日時に不在の場合、又は、受領者の受取拒否、所在不明その他の事由によりアイテムの引渡しが困難な場合には、弊社は、その裁量により、出品者との授受契約の解除その他弊社が適切と認める措置をとることができるものとします。</li>
        <li>前項に定める場合において、弊社は、授受契約の解除又は前項に基づく措置により出品者又は第三者に生じた損害に関して、弊社の故意又は過失に起因する場合を除き、責任を負わないものとします。前項に定める場合において、弊社が損害を被った場合には、出品者は当該損害を賠償するものとします。</li>
    </ol>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm"> 1. 本サービスの中断</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 本サービスの終了及び変更</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 知的財産権等の帰属</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 弊社による利用</h3>
    <p class="u-mb--2">出品者により投稿された出品物の写真、動画、情報等に関しては、本サービスの宣伝、運営、研究開発及び発表等を目的として、弊社及び弊社の指定する者が自由に利用できるものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. コンテンツに関する責任</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. コンテンツの内容等</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">5. バックアップ</h3>
    <p class="u-mb--2">弊社はコンテンツのバックアップを行う義務を負わないものとします。ユーザーは、コンテンツのバックアップが必要な場合には、自己の費用と責任でこれを行うものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">6. コンテンツの変更及び削除</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 必要な機器の準備等</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. ネットワークの経由等</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 手続の成立</h3>
    <p class="u-mb--2">ユーザーがインターネット回線を通じて行う本サービスへの入力、出品、授受、退会、その他の手続は、弊社のサーバーに当該手続に関するデータが送信され、弊社のシステムに当該手続の内容が反映された時点をもって有効に成立するものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. トラブルの解決</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">5. 第三者との紛争解決</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">6. 費用の負担</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 内容等に関する非保証</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 情報提供に関する非保証</h3>
    <p class="u-mb--2">弊社は、本サービスに関連して、ユーザー等に対して、適宜情報提供を行うことがありますが、当該情報の正確性や有用性を保証するものではありません。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. コンピュータウィルス等に関する非保証</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. ユーザーの責任</h3>
    <p class="u-mb--2">ユーザーが本規約に違反した場合、当該ユーザーが、当該違反により損害を受けたユーザー及び第三者に対する損害賠償責任を含む、一切の責任を負うものとします。ユーザーがかかる違反行為を行ったことにより、弊社が損害を被った場合は、当該ユーザーその他関連当事者は連帯して当該損害を賠償するものとします。<br>また、授受成立したにもかかわらず、弊社が定める発送期限を経過しても発送がされず、その後、弊社が定める方法で、催促をしたにも関わらず発送がされない場合は、利用規約を違反する行為とみなされ、違約金（金額1万円）を支払うものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 弊社の免責</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 弊社の責任の範囲</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 通知</h3>
    <ol class="c-list--order u-mb--2">
        ...
        <li>ユーザーが弊社に通知、連絡又は問い合わせをする必要が生じた場合、基本的に本サービスのお問い合わせフォームを利用するものとし、電話や来訪を行うことはできないものとします。弊社は、かかる連絡又は問い合わせがあった場合、弊社が定める方法により、ユーザーの本人確認を行うことができるものとします。また、問合せに対する回答方法に関しては、弊社が適切と考える回答方法を利用することができるものとし、その回答方法をユーザーが決めることはできないものとします。</li>
    </ol>
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 譲渡禁止</h3>
    <p class="u-mb--2">ユーザーは、弊社の書面による事前の承諾なく、本規約に基づく契約上の地位又は本規約に基づく権利若しくは義務につき、第三者に対し、譲渡、移転、担保設定、貸与、その他の処分をすることはできません。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">3. 事業譲渡</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. 分離可能性</h3>
    <p class="u-mb--2">本規約のいずれかの条項又はその一部が、法令等により無効と判断された場合であっても、当該無効とされた以外の部分は、継続して有効に存続するものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">5. 定めのない事項等</h3>
    <p class="u-mb--2">本規約に定めのない事項又は本規約の解釈に疑義が生じた場合には、弊社及びユーザーは、信義誠実の原則に従って協議の上速やかに解決を図るものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">6. 言語</h3>
    <p class="u-mb--2">本規約は、日本語を正文とします。本規約につき、参考のために英語による翻訳文が作成された場合でも、日本語の正文のみが契約としての効力を有するものとし、英訳はいかなる効力も有しないものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">7. 準拠法及び裁判管轄</h3>
    <p class="u-mb--4">本規約は、日本法に基づき解釈されるものとし、ユーザーと弊社の間で生じた紛争については、その内容に応じて福岡簡易裁判所又は福岡地方裁判所を第一審の専属的合意管轄裁判所とします。</p>
</section>
