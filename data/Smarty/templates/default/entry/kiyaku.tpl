...
<section>
  ...
  <form name="form1" id="form1" method="post" action="?">
    ...
    <p class="u-mb--4">弊社は、本サービスに接したユーザー及び第三者の、<a href="<!--{$smarty.const.TOP_URL}-->terms/prohibited_activities.php">ガイドの禁止されている行為</a>に該当すると弊社が合理的な理由に基づき判断する行為（以下「禁止事項」といいます。）を禁止します。</p>
