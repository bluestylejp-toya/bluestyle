...
<section>
  ...
  <form name="form1" id="form1" method="post" action="?">
    ...
    <h3 class="u-mb--1 c-heading--subtitle--sm">2. 適用</h3>
    ...
    <p class="u-mb--4">弊社は、本サービスに接したユーザー及び第三者の、<a href="<!--{$smarty.const.TOP_URL}-->terms/prohibited_activities.php">禁止されている行為</a>に該当すると弊社が合理的な理由に基づき判断する行為（以下「禁止事項」といいます。）を禁止します。</p>
...
<<<<<<< HEAD
    ...
    <p class="u-mb--2">出品者は<a href="<!--{$smarty.const.TOP_URL}-->terms/prohibited_items.php">禁止されている出品物</a>（以下「出品禁止物」といいます。）に記載された商品の出品ができないことについて、予め了承します。出品禁止物に該当する商品を出品した場合は、出品者の故意又は過失に関わらず、本規約違反行為とみなします。</p>
    <h3 class="u-mb--2">3. 商品説明等</h3>
=======
    <h3 class="u-mb--2 c-heading--subtitle--sm">2. 出品禁止商品</h3>
    <p class="u-mb--2">出品者は<a href="<!--{$smarty.const.TOP_URL}-->terms/prohibited_items.php">ガイドの禁止されている出品物</a>（以下「出品禁止物」といいます。）に記載された商品の出品ができないことについて、予め了承します。出品禁止物に該当する商品を出品した場合は、出品者の故意又は過失に関わらず、本規約違反行為とみなします。</p>
...
>>>>>>> CHAIN-367
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 交換手続</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">1. 交換契約の成立</h3>
    ...
    <h3 class="u-mb--2 c-heading--subtitle--sm">4. 物品等に関するトラブル</h3>
    <p class="u-mb--2">交換者の間で物品等に関してトラブルが発生した場合は当該ユーザー間で解決するものとします。但し、弊社の判断により、弊社も協議に入ることができるものとします。</p>
    <h3 class="u-mb--2 c-heading--subtitle--sm">5. キャンセル及び物品の瑕疵</h3>
