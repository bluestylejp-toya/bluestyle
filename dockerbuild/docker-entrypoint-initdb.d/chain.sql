...
INSERT INTO `dtb_bloc` VALUES (1,8,'クレジットカード入力フォーム','sln_regist_credit.tpl','sln_regist_credit','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL,0,1);
...
INSERT INTO `dtb_bloc` VALUES (2,10,'クレジットカード入力フォーム','sln_regist_credit.tpl','sln_regist_credit','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL,0,1);
...
INSERT INTO `dtb_bloc` VALUES (10,13,'クレジットカード入力フォーム','sln_regist_credit.tpl','sln_regist_credit','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL,0,1);
...
INSERT INTO `dtb_csv` VALUES (1,1,'product_id','商品ID',6,3,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK,EXIST_CHECK');
INSERT INTO `dtb_csv` VALUES (2,1,'product_class_id','商品規格ID',NULL,3,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (3,1,'parent_classcategory_id','親規格分類ID',NULL,2,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (4,1,'classcategory_id','規格分類ID',NULL,2,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (5,1,'parent_classcategory_name','親規格分類名',NULL,2,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (6,1,'classcategory_name','規格分類名',NULL,2,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (7,1,'maker_id','メーカーID',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (8,1,'(SELECT name as maker_name FROM dtb_maker WHERE prdcls.maker_id = dtb_maker.maker_id) as maker_name','メーカー名',NULL,2,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (9,1,'name','アイテム名',7,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,EXIST_CHECK');
INSERT INTO `dtb_csv` VALUES (10,1,'status','表示ステータス(公開・非公開)',8,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (11,1,'comment1','メーカーURL(コメント1)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','URL_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,URL_CHECK');
INSERT INTO `dtb_csv` VALUES (12,1,'comment2','コメント2',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (13,1,'comment3','検索ワード(コメント3)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (14,1,'comment4','コメント4',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (15,1,'comment5','コメント5',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (16,1,'comment6','コメント6',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (17,1,'note','備考欄(SHOP専用)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (18,1,'main_list_comment','一覧-メインコメント',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','MTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (19,1,'main_list_image','一覧-メイン画像',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (20,1,'main_comment','詳細-メインコメント',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,HTML_TAG_CHECK');
INSERT INTO `dtb_csv` VALUES (21,1,'main_image','詳細-メイン画像',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (22,1,'main_large_image','詳細-メイン拡大画像 ',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (23,1,'sub_title1','詳細-サブタイトル(1)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (24,1,'sub_comment1','詳細-サブコメント(1)',15,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,HTML_TAG_CHECK');
INSERT INTO `dtb_csv` VALUES (25,1,'sub_image1','詳細-サブ画像(1)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (26,1,'sub_large_image1','詳細-サブ拡大画像(1)',16,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS,EXIST_CHECK');
INSERT INTO `dtb_csv` VALUES (27,1,'sub_title2','詳細-サブタイトル(2)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (28,1,'sub_comment2','詳細-サブコメント(2)',17,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (29,1,'sub_image2','詳細-サブ画像(2)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (30,1,'sub_large_image2','詳細-サブ拡大画像(2)',18,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (31,1,'sub_title3','詳細-サブタイトル(3)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (32,1,'sub_comment3','詳細-サブコメント(3)',19,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (33,1,'sub_image3','詳細-サブ画像(3)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (34,1,'sub_large_image3','詳細-サブ拡大画像(3)',20,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (35,1,'sub_title4','詳細-サブタイトル(4)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (36,1,'sub_comment4','詳細-サブコメント(4)',21,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (37,1,'sub_image4','詳細-サブ画像(4)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (38,1,'sub_large_image4','詳細-サブ拡大画像(4)',22,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (39,1,'sub_title5','詳細-サブタイトル(5)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (40,1,'sub_comment5','詳細-サブコメント(5)',23,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (41,1,'sub_image5','詳細-サブ画像(5)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (42,1,'sub_large_image5','詳細-サブ拡大画像(5)',24,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (43,1,'deliv_date_id','発送日目安ID',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (44,1,'del_flg','削除フラグ',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (45,1,'product_type_id','商品種別ID',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (46,1,'product_code','商品コード',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (47,1,'stock','在庫数',11,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','AMOUNT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (48,1,'stock_unlimited','在庫無制限フラグ',12,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (49,1,'sale_limit','販売制限数',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','AMOUNT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (50,1,'price01','通常価格',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','PRICE_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (51,1,'price02','販売価格',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','PRICE_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (52,1,'deliv_fee','送料',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','PRICE_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (53,1,'point_rate','ポイント付与率',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','PERCENTAGE_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (54,1,'down_filename','ダウンロードファイル名',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (55,1,'down_realfilename','ダウンロード実ファイル',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,DOWN_FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (56,1,'(SELECT recommend_product_id FROM dtb_recommend_products WHERE prdcls.product_id = dtb_recommend_products.product_id ORDER BY `RANK` DESC, recommend_product_id DESC limit 1 offset 0) AS recommend_product_id1','関連商品ID(1)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (57,1,'(SELECT comment FROM dtb_recommend_products WHERE prdcls.product_id = dtb_recommend_products.product_id ORDER BY `RANK` DESC, recommend_product_id DESC limit 1 offset 0) AS recommend_comment1','関連商品コメント(1)',NULL,1,2,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','LLTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
...
INSERT INTO `dtb_csv` VALUES (160,1,'customer_id','会員ID',1,3,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','n','INT_LEN','NUM_CHECK,MAX_LENGTH_CHECK,EXIST_CHECK');
INSERT INTO `dtb_csv` VALUES (161,1,'sub_large_image6','詳細-サブ拡大画像(6)',26,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (162,1,'sub_large_image7','詳細-サブ拡大画像(7)',28,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (163,1,'sub_large_image8','詳細-サブ拡大画像(8)',30,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (164,1,'sub_large_image9','詳細-サブ拡大画像(9)',32,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (165,1,'sub_large_image10','詳細-サブ拡大画像(10)',34,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (166,1,'(SELECT name01  FROM dtb_customer WHERE prdcls.customer_id = dtb_customer.customer_id) as customer_name01','お名前(姓)',2,2,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (167,1,'(SELECT name02  FROM dtb_customer WHERE prdcls.customer_id = dtb_customer.customer_id) as customer_name02','お名前(名)',3,2,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa','STEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK');
INSERT INTO `dtb_csv` VALUES (168,1,'(SELECT kana01  FROM dtb_customer WHERE prdcls.customer_id = dtb_customer.customer_id) as customer_kana01','お名前(フリガナ・姓)',4,2,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa',NULL,NULL);
INSERT INTO `dtb_csv` VALUES (169,1,'(SELECT kana02  FROM dtb_customer WHERE prdcls.customer_id = dtb_customer.customer_id) as customer_kana02','お名前(フリガナ名)',5,2,1,'2021-01-13 01:40:20','2021-11-12 17:38:58','KVa',NULL,NULL);
INSERT INTO `dtb_csv` VALUES (170,1,'sub_large_image6','詳細-サブコメント(6)',25,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (171,1,'sub_large_image7','詳細-サブコメント(7)',27,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (172,1,'sub_large_image8','詳細-サブコメント(8)',29,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (173,1,'sub_large_image9','詳細-サブコメント(9)',31,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
INSERT INTO `dtb_csv` VALUES (174,1,'sub_large_image10','詳細-サブコメント(10)',33,1,1,'2021-01-13 01:40:20','2021-11-12 17:38:58',NULL,'LTEXT_LEN','SPTAB_CHECK,MAX_LENGTH_CHECK,FILE_EXISTS');
...
CREATE TABLE `dtb_customer` (
  ...
  UNIQUE KEY `password_reset_code` (`password_reset_code`),
...
INSERT INTO `dtb_pagelayout` VALUES (1,38,'商品購入/決済画面','shopping/load_sln_payment_module.php','shopping/load_sln_payment_module',1,1,2,NULL,NULL,NULL,'http://localhost:8080/chainadmin/load_module_config.php?module_id=2073','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL);
...
INSERT INTO `dtb_pagelayout` VALUES (2,30,'商品購入/決済画面','shopping/load_sln_payment_module.php','shopping/load_sln_payment_module',1,1,2,NULL,NULL,NULL,'http://localhost:8080/chainadmin/load_module_config.php?module_id=2073','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL);
INSERT INTO `dtb_pagelayout` VALUES (2,31,'MYページ/登録済カード情報変更','mypage/card_info.php','mypage/card_info',1,1,2,NULL,NULL,NULL,'http://localhost:8080/chainadmin/load_module_config.php?module_id=2073','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL);
...
INSERT INTO `dtb_pagelayout` VALUES (10,50,'商品購入/決済画面','shopping/load_sln_payment_module.php','shopping/load_sln_payment_module',1,1,2,NULL,NULL,NULL,'http://localhost:8080/chainadmin/load_module_config.php?module_id=2073','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL);
INSERT INTO `dtb_pagelayout` VALUES (10,51,'MYページ/登録済カード情報変更','mypage/card_info.php','mypage/card_info',1,1,2,NULL,NULL,NULL,'http://localhost:8080/chainadmin/load_module_config.php?module_id=2073','2021-09-16 09:35:11','2022-03-16 03:17:43',NULL);
...
INSERT INTO `dtb_payment` VALUES (6,'クレジットカード',0,1,3,NULL,3,0,0,2,'2021-09-16 09:35:11','2022-03-16 03:17:43',NULL,NULL,1,NULL,NULL,NULL,'/var/www/html/../data/downloads/module/mdl_sln/payment.php',NULL,NULL,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'mdl_sln');
...
INSERT INTO `dtb_plugin` VALUES (1,'ソニーペイメントサービス決済プラグイン','SLNCore','SLNCore','ソニーペイメントサービス','http://www.sonypaymentservices.jp/','http://www.sonypaymentservices.jp/','1.0','2.17.0','ソニーペイメントサービス決済モジュールの動作に必要なプラグインです。決済を利用する場合に、本プラグインの無効化や削除はしないで下さい。',0,1,NULL,NULL,NULL,NULL,'2021-09-16 09:35:11','2022-03-16 03:17:43');
...
INSERT INTO `dtb_products` VALUES (1,'Aバッグ',0,1,'','','','','','','','','','テスト\nテスト','','','','','','ice500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,1,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (2,'B時計',0,1,'','','','','','','','','','テスト\nテスト','','','','','','nabe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,2,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (3,'C服',0,1,'','','','','','','','','','テスト\nテスト','','','','','','recipe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,3,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (4,'C時計',0,1,'','','','','','','','','','テスト\nテスト','','','','','','ice500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,3,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (5,'D時計',0,1,'','','','','','','','','','テスト\nテスト','','','','','','nabe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,4,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (6,'D本',0,1,'','','','','','','','','','テスト\nテスト','','','','','','recipe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,4,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (7,'E時計',0,1,'','','','','','','','','','テスト\nテスト','','','','','','ice500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,5,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (8,'F服',0,1,'','','','','','','','','','テスト\nテスト','','','','','','nabe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,6,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (9,'G本',0,1,'','','','','','','','','','テスト\nテスト','','','','','','recipe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,7,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (10,'Hバッグ',0,1,'','','','','','','','','','テスト\nテスト','','','','','','ice500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,8,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (11,'I時計',0,1,'','','','','','','','','','テスト\nテスト','','','','','','nabe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,9,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (12,'I服',0,1,'','','','','','','','','','テスト\nテスト','','','','','','recipe500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,9,0,NULL,NULL,1);
INSERT INTO `dtb_products` VALUES (13,'Jバッグ',0,1,'','','','','','','','','','テスト\nテスト','','','','','','ice500.jpg','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',0,0,'2021-10-06 00:00:00','2021-10-06 00:00:00',0,10,0,NULL,NULL,1);
...
INSERT INTO `mtb_constants` VALUES ('FORGOT_MAIL','1',95,'パスワード忘れの確認メールを送付するか否か。(0:送信しない、1:送信する)');
...
INSERT INTO `mtb_constants` VALUES ('SAMPLE_ADDRESS2','\"番地(例：1-3-5)\"',2,'フロント表示関連');
INSERT INTO `mtb_constants` VALUES ('SAMPLE_ADDRESS3','\"ビル名\"',2,'フロント表示関連');
...
--
-- Table structure for table `mtb_size`
--

DROP TABLE IF EXISTS `mtb_size`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mtb_size` (
  `id` smallint NOT NULL,
  `name` text,
  `RANK` smallint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `mtb_size`
--

LOCK TABLES `mtb_size` WRITE;
/*!40000 ALTER TABLE `mtb_size` DISABLE KEYS */;
INSERT INTO `mtb_size` VALUES (1,'A4サイズ',0);
INSERT INTO `mtb_size` VALUES (2,'60サイズ',1);
INSERT INTO `mtb_size` VALUES (3,'80サイズ',2);
INSERT INTO `mtb_size` VALUES (4,'100サイズ',3);
INSERT INTO `mtb_size` VALUES (5,'120サイズ',4);
INSERT INTO `mtb_size` VALUES (6,'140サイズ',5);
INSERT INTO `mtb_size` VALUES (7,'160サイズ',6);
/*!40000 ALTER TABLE `mtb_size` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-04-21  4:07:05
